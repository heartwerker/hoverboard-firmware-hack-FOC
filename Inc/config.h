...
#define N_MOT_MAX       100000            // [rpm] Maximum motor speed limit
...
#define DEFAULT_FILTER              6553  // Default for FILTER 0.1f [-] lower value == softer filter [0, 65535] = [0.0 - 1.0]. // 1 = direct 
...
// ############################ VARIANT_USART SETTINGS ############################
  ...
  #define USE_CMD_L_R  1 // steer becomes L, speed becomes R
